...
NO_MEMBERS_FOUND = "No members found for this search criterion."
VIEW_PROFILE = "./memberlist.php?mode=viewprofile&u="
...
ALL_TABLES = [
    ...
    "phpbb_styles_imageset_data","phpbb_styles_template",
